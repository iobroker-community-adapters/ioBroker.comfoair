...
### ComfoAir State Management Examples
```javascript
...
### ComfoAir Specific Dependencies
...
- Object Definitions: All state objects are predefined in `io-package.json` with proper types, roles, units, and value mappings for ComfoAir protocol data

### ComfoAir Performance Considerations
...
### ComfoAir Security Best Practices
